...
function App() {
  ...
  return (
    <div className="App">
      <div> <input type="text" value={password} placeholder='Password...' readOnly /><button onClick={() => navigator.clipboard.writeText(password)}>Copy</button>
      </div>
      <div>
      ...
      <div><input type="checkbox" checked={includeUpperref.current} onChange={() => handlechange(includeUpperref)} /> Include uppercase
