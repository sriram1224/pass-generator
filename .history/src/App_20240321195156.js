...
function App() {
  ...
  return (
    <div className="App">
      <label>
      <input type="number" value={length} onChange={(e) => setLength(parseInt(e.target.value))} min="1" max="50" /> Password length
     </label> <label> <input type="text"  value={password} placeholder='Password...'   readOnly />
